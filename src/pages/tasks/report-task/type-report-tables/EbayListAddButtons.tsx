...
const addNewTask = async (data: ITaskInfoRes, message: MessageInstance,state:GlobalState) => {
  try {
    ...
    message.error(`Ошибка добавления задания ` + ApiError.FromAxios(error))
  }
}



const EbayListAddButtons: React.FC<{ data: ITaskInfoRes }> = ({ data }) => {
...
export default EbayListAddButtons;
